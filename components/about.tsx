  ...
  <section id="about" className="mt-8">
      ...
      <div className="flex justify-between items-center w-full mb-4">
        ...
        >
            ...
            <kbd className="px-1.5 py-0.5 rounded border border-border bg-muted/50 font-mono text-sm font-medium text-muted-foreground group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-all duration-300">D</kbd>
        </div>
      </div>
