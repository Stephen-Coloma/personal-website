    ...
    <div className="flex flex-col gap-1 h-full">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-1 text-foreground">
          <h1 className="text-base font-semibold tracking-wide">Stephen Coloma</h1>
          <BadgeCheck className="h-4 w-4 text-blue-500" />
        </div>

        <div className="flex items-center gap-1 text-muted-foreground">
          <MapPin className="h-3.5 w-3.5 text-primary" />
          <span className="text-xs font-medium tracking-tight">Baguio City, Philippines</span>
        </div>

        {/* Action Buttons */}
        <Button variant="default" className="w-full justify-start cursor-pointer relative">
          <Phone className="mr-2 h-3.5 w-3.5 shrink-0" />
          <span className="text-xs font-medium tracking-tight">Book a call</span>
          <ArrowRight className="absolute right-2 h-3.5 w-3.5 shrink-0" />
        </Button>
        ...
        <div className="flex items-center">
          ...
          <Button variant="link" className="w-1/2 cursor-pointer">
            <span className="text-xs font-medium tracking-tight">Email me</span>
          </Button>
        </div>
      </div>
    </div>
